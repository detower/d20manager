...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'general_charskill', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('character', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trained_skills', to=orm['general.Character'])),
        ...
        db.send_create_signal(u'general', ['CharSkill'])


    def backwards(self, orm):
        # Deleting model 'CharSkill'
        db.delete_table(u'general_charskill')
    ...
    models = {
        ...
        u'general.charskill': {
            ...
            'character': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'trained_skills'", 'to': u"orm['general.Character']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
