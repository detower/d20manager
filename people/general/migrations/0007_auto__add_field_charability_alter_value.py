...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CharAbility.alter_value'
        db.add_column(u'general_charability', 'alter_value',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CharAbility.alter_value'
        db.delete_column(u'general_charability', 'alter_value')
