...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CharRace'
        db.create_table(u'races_charrace', (
        ...
        db.send_create_signal(u'races', ['CharRace'])

        # Adding unique constraint on 'CharRace', fields ['character', 'race']
        db.create_unique(u'races_charrace', ['character_id', 'race_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CharRace', fields ['character', 'race']
        db.delete_unique(u'races_charrace', ['character_id', 'race_id'])

        # Deleting model 'CharRace'
        db.delete_table(u'races_charrace')
    ...
    models = {
        ...
        u'races.charrace': {
            'Meta': {'unique_together': "(['character', 'race'],)", 'object_name': 'CharRace'},
