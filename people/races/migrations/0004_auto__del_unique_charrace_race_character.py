...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CharRace', fields ['race', 'character']
        db.delete_unique(u'races_charrace', ['race_id', 'character_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'CharRace', fields ['race', 'character']
        db.create_unique(u'races_charrace', ['race_id', 'character_id'])
    ...
    models = {
        ...
        u'races.charrace': {
            ...
            'character': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'race'", 'to': u"orm['general.Character']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
