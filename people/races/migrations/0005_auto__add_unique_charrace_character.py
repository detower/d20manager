...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CharRace', fields ['character']
        db.create_unique(u'races_charrace', ['character_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CharRace', fields ['character']
        db.delete_unique(u'races_charrace', ['character_id'])
